"""
Train a long-seasonality LightGBM model on processed_v2 features (includes lag/roll 91/182/365, price stats).
Validates on d_1914–d_1941 for selected stores (default CA_1, TX_1, WI_1).
Outputs metrics to weight_v2/summary_v2_long.json (does not overwrite baseline).
"""
...
SUMMARY_PATH = OUT_DIR / "summary_v2_long.json"

STORES = ["CA_1", "TX_1", "WI_1"]
TRAIN_END = 1913
VAL_END = 1941

# Model params (conservative)
PARAMS = dict(
